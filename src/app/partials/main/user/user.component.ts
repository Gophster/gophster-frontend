...
export class UserComponent implements OnInit, OnDestroy {
  ...
  public isFollowing() {
    const sendHandle = { handle: this.user.handle };
    this.isFollowingSubscription = this.userService
      .isFollowing(sendHandle)
      .subscribe(
        (response) => {
  ...
  public deleteGoph(item: any) {
    this.deleteGophSubscription = this.gophsService
      .deleteGoph(item.id)
      .subscribe((response) => {
  ...
  public onEditGoph(editedItem: any, index: number) {
    ...
    this.editGophSubscription = this.gophsService
      .editGoph(editedItem.id, sendObject)
      .subscribe((response) => {
